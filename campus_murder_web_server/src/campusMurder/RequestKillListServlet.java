...
public class RequestKillListServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		boolean logged = false;
		   ...
		   if(!logged) {
				System.out.println("WARNING: UNLOGGED REQUEST KILL LIST");
			...
			JSONObject jsonObject = DBConnect.getInstance().getKillList(session);
