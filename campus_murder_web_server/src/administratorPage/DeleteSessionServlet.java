...
public class DeleteSessionServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		System.out.println("received delete session");
		if((int) request.getSession().getAttribute("status_code") != 250) {
			System.out.println("CRITICAL: UNLOGGED DELETE OBJECT LIST");
		}else {
			...
			JSONObject jsonObject = DBConnect.getInstance().deleteSession(session_name);
