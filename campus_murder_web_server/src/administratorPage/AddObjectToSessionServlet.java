...
public class AddObjectToSessionServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		System.out.println("received add objects to session");
		if((int) request.getSession().getAttribute("status_code") != 250) {
			System.out.println("WARNING: UNLOGGED ADD OBJECT TO SESSION");
		}else {
			...
			JSONObject jsonObject = DBConnect.getInstance().addObjectToSession(object_name, session_name);
