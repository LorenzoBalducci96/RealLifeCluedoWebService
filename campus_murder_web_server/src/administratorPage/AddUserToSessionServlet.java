...
public class AddUserToSessionServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if((int) request.getSession().getAttribute("status_code") != 250) {
			...
			int points = Integer.parseInt(jobj.getString("points"));

			JSONObject jsonObject = DBConnect.getInstance().addUserToSession(username, points, session_name);
