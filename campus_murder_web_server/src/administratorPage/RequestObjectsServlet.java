...
public class RequestObjectsServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if((int) request.getSession().getAttribute("status_code") != 250) {
			System.out.println("WARNING: UNLOGGED REQUEST OBJECT LIST REQUEST");
		}else {
			JSONObject jsonObject = DBConnect.getInstance().getObjectList();
