...
public class RequestSessionUsersServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		System.out.println("received session users list");
		if((int) request.getSession().getAttribute("status_code") != 250) {
			...
			JSONObject jsonObject = DBConnect.getInstance().getSessionUsersList(session_name);
